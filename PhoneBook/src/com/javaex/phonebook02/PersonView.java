...
public class PersonView {
	...
	// 수정2
	public void update(String updateStr , String columnNo, int no) {
		
		PersonDao personDao = new PersonDao();
		
		int count = personDao.personUpdate(updateStr, columnNo, no);
		if(count == 1) {
